...
public class ReceiptModel {
  ...
  private List<AnyOfReceiptModelPaymentsItems> payments = new ArrayList<AnyOfReceiptModelPaymentsItems>();
  ...
  private ShiftWithCashierAndCashRegister shift = null;

  @SerializedName("control_number")
  private String controlNumber = null;

  public ReceiptModel id(UUID id) {
    this.id = id;
    return this;
  }
  ...
  **/
  ...
  public ReceiptModel type(ReceiptType type) {
    this.type = type;
    return this;
  }
  ...
  **/
  ...
  public ReceiptModel transaction(ShortTransaction transaction) {
  ...
  **/
  ...
  public ReceiptModel serial(Integer serial) {
    this.serial = serial;
    return this;
  }
  ...
  **/
  ...
  public ReceiptModel status(ReceiptStatus status) {
    this.status = status;
    return this;
  }
  ...
  **/
  ...
  public ReceiptModel goods(List<GoodItemModel> goods) {
    this.goods = goods;
    return this;
  }

  public ReceiptModel addGoodsItem(GoodItemModel goodsItem) {
  ...
  **/
  ...
  public ReceiptModel payments(List<AnyOfReceiptModelPaymentsItems> payments) {
    this.payments = payments;
    return this;
  }

  public ReceiptModel addPaymentsItem(AnyOfReceiptModelPaymentsItems paymentsItem) {
  ...
  **/
  @Schema(required = true, description = "")
  public List<AnyOfReceiptModelPaymentsItems> getPayments() {
    return payments;
  }

  public void setPayments(List<AnyOfReceiptModelPaymentsItems> payments) {
    this.payments = payments;
  }

  public ReceiptModel totalSum(Integer totalSum) {
  ...
  **/
  ...
  public ReceiptModel totalPayment(Integer totalPayment) {
  ...
  **/
  ...
  public ReceiptModel totalRest(Integer totalRest) {
  ...
  **/
  ...
  public ReceiptModel fiscalCode(String fiscalCode) {
  ...
  **/
  ...
  public ReceiptModel fiscalDate(OffsetDateTime fiscalDate) {
  ...
  **/
  ...
  public ReceiptModel deliveredAt(OffsetDateTime deliveredAt) {
  ...
  **/
  ...
  public ReceiptModel createdAt(OffsetDateTime createdAt) {
  ...
  **/
  ...
  public ReceiptModel updatedAt(OffsetDateTime updatedAt) {
  ...
  **/
  ...
  public ReceiptModel taxes(List<GoodTax> taxes) {
    this.taxes = taxes;
    return this;
  }

  public ReceiptModel addTaxesItem(GoodTax taxesItem) {
  ...
  **/
  ...
  public ReceiptModel discounts(List<DiscountModel> discounts) {
    this.discounts = discounts;
    return this;
  }

  public ReceiptModel addDiscountsItem(DiscountModel discountsItem) {
  ...
  **/
  ...
  public ReceiptModel header(String header) {
    this.header = header;
    return this;
  }
  ...
  **/
  ...
  public ReceiptModel footer(String footer) {
    this.footer = footer;
    return this;
  }
  ...
  **/
  ...
  public ReceiptModel barcode(String barcode) {
  ...
  **/
  ...
  public ReceiptModel isCreatedOffline(Boolean isCreatedOffline) {
  ...
  **/
  ...
  public ReceiptModel isSentDps(Boolean isSentDps) {
  ...
  **/
  ...
  public ReceiptModel sentDpsAt(OffsetDateTime sentDpsAt) {
  ...
  **/
  ...
  public ReceiptModel taxUrl(String taxUrl) {
    this.taxUrl = taxUrl;
    return this;
  }
  ...
  **/
  ...
  public ReceiptModel relatedReceiptId(UUID relatedReceiptId) {
  ...
  **/
  ...
  public ReceiptModel technicalReturn(Boolean technicalReturn) {
  ...
  **/
  ...
  public ReceiptModel currencyExchange(CurrencyExchangeSchema currencyExchange) {
  ...
  **/
  ...
  public ReceiptModel shift(ShiftWithCashierAndCashRegister shift) {
    this.shift = shift;
    return this;
  }
  ...
  **/
  @Schema(required = true, description = "")
  public ShiftWithCashierAndCashRegister getShift() {
    return shift;
  }

  public void setShift(ShiftWithCashierAndCashRegister shift) {
    this.shift = shift;
  }

  public ReceiptModel controlNumber(String controlNumber) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.id, receiptModel.id) &&
        ...
        Objects.equals(this.transaction, receiptModel.transaction) &&
        Objects.equals(this.serial, receiptModel.serial) &&
        Objects.equals(this.status, receiptModel.status) &&
        Objects.equals(this.goods, receiptModel.goods) &&
        Objects.equals(this.payments, receiptModel.payments) &&
        Objects.equals(this.totalSum, receiptModel.totalSum) &&
        Objects.equals(this.totalPayment, receiptModel.totalPayment) &&
        Objects.equals(this.totalRest, receiptModel.totalRest) &&
        Objects.equals(this.fiscalCode, receiptModel.fiscalCode) &&
        Objects.equals(this.fiscalDate, receiptModel.fiscalDate) &&
        Objects.equals(this.deliveredAt, receiptModel.deliveredAt) &&
        Objects.equals(this.createdAt, receiptModel.createdAt) &&
        Objects.equals(this.updatedAt, receiptModel.updatedAt) &&
        Objects.equals(this.taxes, receiptModel.taxes) &&
        Objects.equals(this.discounts, receiptModel.discounts) &&
        Objects.equals(this.header, receiptModel.header) &&
        Objects.equals(this.footer, receiptModel.footer) &&
        Objects.equals(this.barcode, receiptModel.barcode) &&
        Objects.equals(this.isCreatedOffline, receiptModel.isCreatedOffline) &&
        Objects.equals(this.isSentDps, receiptModel.isSentDps) &&
        Objects.equals(this.sentDpsAt, receiptModel.sentDpsAt) &&
        Objects.equals(this.taxUrl, receiptModel.taxUrl) &&
        Objects.equals(this.relatedReceiptId, receiptModel.relatedReceiptId) &&
        Objects.equals(this.technicalReturn, receiptModel.technicalReturn) &&
        Objects.equals(this.currencyExchange, receiptModel.currencyExchange) &&
        Objects.equals(this.shift, receiptModel.shift) &&
        Objects.equals(this.controlNumber, receiptModel.controlNumber);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, type, transaction, serial, status, goods, payments, totalSum, totalPayment, totalRest, fiscalCode, fiscalDate, deliveredAt, createdAt, updatedAt, taxes, discounts, header, footer, barcode, isCreatedOffline, isSentDps, sentDpsAt, taxUrl, relatedReceiptId, technicalReturn, currencyExchange, shift, controlNumber);
  }
