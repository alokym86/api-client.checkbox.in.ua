...
import okio.Okio;
import ua.checkbox.j8client.auth.ApiKeyAuth;
import ua.checkbox.j8client.auth.Authentication;
import ua.checkbox.j8client.auth.HttpBasicAuth;
import ua.checkbox.j8client.auth.OAuth;
...
public class ApiClient {
    ...
    private String basePath = "https://api.checkbox.in.ua";

	private boolean debugging = false;
    private Map<String, String> defaultHeaderMap = new HashMap<String, String>();
    private String tempFolderPath = null;
    private String cashierTokenName = "Cashier JWT token";
    ...
    public ApiClient() {
        ...
        authentications.put(cashierTokenName, new OAuth());
        ...
        call.enqueue(new Callback() {
            ...
            public void onResponse(Response response) throws IOException {
                ...
                try {
                    ...
                    if (result instanceof CashierAccessTokenResponseModel) {
                    	setAutorized(false);
                    	setAccessToken(((CashierAccessTokenResponseModel) result).getAccessToken());
                    	setAutorized(true);
                }
